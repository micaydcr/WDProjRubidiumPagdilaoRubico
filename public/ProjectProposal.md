...
- Enables drag-and-drop functionality for toppings and decorations.
...
- Allow the user to download the cake they made
...
- To allow the users save the cake they made, we will convert the cake preview into an image that they can download.
